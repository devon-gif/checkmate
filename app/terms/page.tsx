    ...
    >
      ...
      <LegalSection title="1. About CheckRay">
        <p>
          ...
          notices, job listings, links, and other documents
          (&ldquo;Items&rdquo;).
        </p>
        ...
        <p>
          AI and automated analysis can be wrong. Results are probabilistic and
          informational only. You are responsible for your own decisions. Always
      ...
      <LegalSection title="3. Your Account">
        <p>
          ...
          credentials. Notify us immediately via our{' '}
      ...
      <LegalSection title="5. User Content & License">
        <p>
          ...
          without your explicit consent. You retain all ownership rights.
        </p>
      </LegalSection>
      ...
      <LegalSection title="6. Subscriptions, Billing & Refunds">
        ...
        <LawyerNote>
          [LAWYER REVIEW: refund policy — specify pro-rated refund,
          cancellation, and chargeback dispute policies in detail.]
        </LawyerNote>
      </LegalSection>
      ...
      <LegalSection title="7. Disclaimers & No Guarantees">
        ...
        <p className="font-semibold">
          ...
          PROFESSIONAL OR AUTHORITY IMMEDIATELY.
        </p>
      </LegalSection>

      <LegalSection title="8. Limitation of Liability">
        <p>
          TO THE MAXIMUM EXTENT PERMITTED BY LAW, CHECKMATE SHALL NOT BE LIABLE
          FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE
          DAMAGES. OUR TOTAL LIABILITY SHALL NOT EXCEED THE GREATER OF (A)
          AMOUNTS YOU PAID US IN THE PRIOR 12 MONTHS, OR (B) $100 USD.
        </p>
        <LawyerNote>
      ...
      <LegalSection title="10. Dispute Resolution">
        <LawyerNote>
          [LAWYER REVIEW: arbitration clause, class action waiver, governing
          law, and venue.]
        </LawyerNote>
        <p>
      ...
      <LegalSection title="11. Account Termination">
        <p>
          ...
          Terms. You may delete your account at any time. Upon termination, your
          data is handled per our{' '}
      ...
      <LegalSection title="12. Changes to These Terms">
        <p>
          We may update these Terms from time to time. We will prompt you to
          review and accept any material updates before continuing to use the
          service.
        </p>
      </LegalSection>

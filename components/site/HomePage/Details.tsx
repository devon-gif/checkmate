    ...
    >
      <div className="center">
        ...
        <div className="flex flex-wrap -mt-4 -mx-2">
          <Item1
            title="Free"
            subtitle="Paste or forward to Ray"
            content="Paste a job post, recruiter message, suspicious text, or link. Or forward an email. No account needed for your first check."
            image="/images/details-pic-1.png"
          />
          <Item1
            title="Seconds"
            subtitle="Ray checks for red flags"
            content="Ray looks for fake-check patterns, vague job signals, urgency language, lookalike links, impersonation, and unusual money asks."
